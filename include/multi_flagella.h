...
#ifndef FLAGELLA_SIMU_MULTI_FLAGELLA_H
#define FLAGELLA_SIMU_MULTI_FLAGELLA_H
...
class MultiFlagella: public Simulation {
  public:
    int num_iters_ = 0;
    int iter_ = 0;
    Param params_ = {
    ...
    // constructor
    MultiFlagella(int num_iters) {
      num_iters_ = num_iters;
      pos_ = mat(num_grids_, 3);
      pos_next_ = mat(num_grids_, 3);
      posL_ = mat(n_flagella_, 3);
      vectL_ = mat(n_flagella_, 3);
      f_ = mat(num_grids_, 3);
      pos_.zeros();
      f_.zeros();
...
#endif //FLAGELLA_SIMU_MULTI_FLAGELLA_H
